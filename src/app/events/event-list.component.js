...
var EventListComponent = (function () {
    function EventListComponent(_eventService) {
        ...
        this.pageTitle = 'Events List! YAY!!!';
        this.imageWidth = 50;
        this.showImages = false;
        this.events = [];
    }
    Object.defineProperty(EventListComponent.prototype, "listFilter", {
        get: function () {
    ...
    EventListComponent.prototype.performFilter = function (filterBy) {
        filterBy = filterBy.toLocaleLowerCase();
        return this.events.filter(function (event) { return event.title.toLocaleLowerCase().indexOf(filterBy) != -1; });
    };
